...
class SeedWorkStreams extends Seeder
{
    ...
    public function run()
    {
        ...
        WorkStream::create(array('program_id' => 1,'name' => 'Work Scheduling and Experimental Design', 'Status' => 0, 'phase'=>'2B', 'RAG' => 'A', 'StartDate'=> date_create('01/01/2014'), 'EndDate'=> date_create('07/01/2016'), 'description' => 'Protocol and Site Placement plus other projects to enable these and put FPLS beyond use' ));
