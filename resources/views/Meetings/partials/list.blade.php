<div class="jarviswidget jarviswidget-color-darken" id="wid-id-meetings" data-widget-editbutton="false" data-widget-deletebutton="false">
    ...
    <header>
        ...
        <div class="widget-toolbar">
            <a href="{{action('MeetingController@create', [$subject->subjecttype, $subject->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add new Meeting</a>
            <a href="{{action('MeetingController@index', [$subject->subjecttype, $subject->id])}}" class="btn btn-default"><i class="fa fa-eye"></i> View All </a>
        </div>
    </header>
