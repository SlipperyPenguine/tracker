...
use tracker\Repositories\DecisionRepository;
use tracker\Repositories\MeetingRepository;

class DecisionController extends TrackerController
{
    /**
     ...
     */
    public function __construct(DecisionRepository $repository, MeetingRepository $meetingRepository)
    {
        $this->repository = $repository;
        $this->meetingRepository = $meetingRepository;

        $this->viewRoot = 'Decisions';
        $this->controllerName = 'DecisionController';
    }
    ...
    public function store(Request $request)
    {
        ...
        flash()->success('Success', "New Decision created successfully");
    ...
    public function update(Request $request, $id)
    {
        ...
        flash()->success('Success', "Decision updated successfully");
